  ...
  return (
    <section className="workspace ed-page">
      <CaseHeader
        ...
        statusBadge="🔍 Evidence Collection"
        backLabel="Back to Story"
        onBack={onBack}
      />

      <InvestigationProgress currentStep="evidence" />
        ...
        <div className="ir-left">
          ...
          <div className="panel ir-notebook-card">
            ...
            <textarea
              ...
              placeholder="What did you notice while investigating?"
              rows={4}
            />
          </div>
        </div>
          ...
          <div className="panel ir-editor-card">
            <div className="ir-editor-toolbar">
              ...
              <div className="ir-editor-actions">
                ...
                <button className="ir-editor-btn" onClick={handleReset} title="Reset output">
                  <RotateCcw size={13} /> Reset
                </button>
                <button className="ir-editor-btn ir-run-btn" onClick={handleRunCode} title="Run code">
