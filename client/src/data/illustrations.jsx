...
const ILLUSTRATION_MAP = {
  ...
  'bu-syn-1': () => <ComicImage id="bu-syn-1" FallbackSVG={DataFilterIllustration} alt="Data Filter" />,
  'bu-run-1': () => <ComicImage id="bu-run-1" FallbackSVG={DictionaryExplorerIllustration} alt="Dictionary Explorer" />,
  'bu-run-2': () => <ComicImage id="bu-run-2" FallbackSVG={DivisionToolIllustration} alt="Division Tool" />,
  'bu-run-3': () => <ComicImage id="bu-run-3" FallbackSVG={NumberConverterIllustration} alt="Number Converter" />,
  'bu-log-1': () => <ComicImage id="bu-log-1" FallbackSVG={BookSearchIllustration} alt="Book Search" />,
  'bu-log-2': () => <ComicImage id="bu-log-2" FallbackSVG={FruitFinderIllustration} alt="Fruit Finder" />,
  'bu-log-3': () => <ComicImage id="bu-log-3" FallbackSVG={AgeGateIllustration} alt="Age Gate" />,
  'bu-log-4': () => <ComicImage id="bu-log-4" FallbackSVG={NumberSorterIllustration} alt="Number Sorter" />,
  'bu-log-5': () => <ComicImage id="bu-log-5" FallbackSVG={TemperatureLabIllustration} alt="Temperature Lab" />,
  'bu-log-6': () => <ComicImage id="bu-log-6" FallbackSVG={ScoreAnalyzerIllustration} alt="Score Analyzer" />,
};
